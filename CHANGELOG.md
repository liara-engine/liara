...
* **release:** add configuration for release-please with custom config and manifest files ([9428dbd](https://github.com/liara-engine/liara/commit/9428dbd0d60a976821b9cf1f5f4d8ee6bf18586a))
* **release:** enable separate pull requests in release-please configuration ([40dec70](https://github.com/liara-engine/liara/commit/40dec70c8dcdf4f024210fe05daf547dc3fc1faf))
...
* **release:** add bump strategies and versioning ([3383e9d](https://github.com/liara-engine/liara/commit/3383e9dcdb8ded68bb64c39f6f6e91e4a20c2d58))
