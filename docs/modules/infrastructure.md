...
The full guide lives in this repository's own documentation<!-- TODO link → the docs-shared guide, once the cross-repository link form is settled -->, and it is worth reading before changing anything here, because the blast radius of a change is every site at once.
